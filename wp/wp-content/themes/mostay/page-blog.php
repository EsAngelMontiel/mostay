...
<section class="blog" data-animate="fade-in">
  <h1 class="titulo-oculto" data-animate="typing">Blog</h1>
    <?php
      ...
      $args = array(
        ...
        'posts_per_page' => 8,                 // Número de artículos por página (ajusta si lo necesitas)
        'order'          => 'DESC',            // Orden descendente (más recientes primero)
        'paged'          => $paged,            // La página actual para la carga inicial
    ...
    ?>
    <ul id="posts-container" class="blog-posts-list" data-animate="stagger"> 
      <?php
        ...
        if ($main_query->have_posts()) :
          ...
          ?>
            <li data-stagger-item><p>No se encontraron entradas de blog.</p></li>
          <?php
    ...
    ?>
        <div class="load-more-wrapper" style="text-align: center; margin-top: 30px; margin-bottom: 30px;" data-animate="fade-in">
